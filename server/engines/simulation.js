...
Return JSON: {
  ...
  "scenarios": [
    { "label": "Option A — High-level description", "timeline": "X months", "success": 30-88, "risk": "High" },
    { "label": "Option B — High-level description", "timeline": "X months", "success": 65-88, "risk": "Medium" },
    { "label": "Option C — High-level description", "timeline": "X months", "success": 50-75, "risk": "Low" }
  ],
