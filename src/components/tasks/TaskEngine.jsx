...
const styles = {
  ...
  sprint: { padding: '1rem 1.25rem', background: 'var(--accent-subtle)', border: '1px solid var(--border)', borderRadius: '14px', marginBottom: '0.75rem' },
  ...
  filterBtn: { padding: '0.375rem 0.875rem', background: 'var(--bg-elevated)', border: '1px solid var(--border)', borderRadius: '8px', fontSize: '0.8125rem', color: 'var(--color-text-secondary)', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '0.375rem', transition: 'all 0.2s' },
  filterActive: { background: 'var(--accent-subtle)', borderColor: 'var(--accent)', color: 'var(--accent)' },
  filterCount: { fontSize: '0.6875rem', padding: '0 0.375rem', background: 'var(--bg-elevated)', borderRadius: '4px' },
  addRow: { display: 'flex', gap: '0.5rem', marginBottom: '1.25rem' },
  addInput: { flex: 1, padding: '0.625rem 1rem', fontSize: '0.875rem', background: 'var(--bg-card)', border: '1px solid var(--border)', borderRadius: '10px', color: 'var(--color-text-primary)', fontFamily: 'inherit' },
  taskList: { display: 'flex', flexDirection: 'column', gap: '0.5rem' },
  taskCard: { display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '0.875rem 1rem', background: 'var(--bg-card)', border: '1px solid var(--border)', borderRadius: '12px', transition: 'all 0.2s' },
  ...
  statusSelect: { padding: '0.25rem 0.5rem', background: 'var(--bg-card)', border: '1px solid var(--border)', borderRadius: '6px', fontSize: '0.6875rem', color: 'var(--color-text-secondary)', cursor: 'pointer' },
};
