      ...
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '1rem', background: 'var(--bg)' }}>
        <div style={{ width: '100%', maxWidth: '420px' }}>
          <ThreeDCard intensity={3}>
            <SlashCard style={{ textAlign: 'center' }}>
              ...
              <Link to="/auth" style={{ color: 'var(--accent-light)' }}>Go to Login</Link>
            </SlashCard>
          </ThreeDCard>
        </div>
      </div>
      ...
      <div style={{ width: '100%', maxWidth: '420px' }}>
        <ThreeDCard intensity={3}>
          <SlashCard variant="accent" style={{ textAlign: 'center' }}>
            <Lock size={32} style={{ color: 'var(--accent-light)', marginBottom: '1rem' }} />
            ...
            <div style={{ textAlign: 'center', marginTop: '1rem' }}>
              <Link to="/auth" style={{ color: 'var(--accent-light)', fontSize: '0.875rem', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '0.25rem' }}>
